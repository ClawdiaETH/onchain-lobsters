...
export function renderLobsterSVG(traits: Traits, scale = 10): string {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${vw}" height="${vh}" viewBox="0 0 ${vw} ${vh}" shape-rendering="crispEdges" style="image-rendering:pixelated;image-rendering:crisp-edges">${rects.join('')}</svg>`;
}
