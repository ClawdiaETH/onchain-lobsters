// Shared pixel lobster SVG for favicon/apple-icon generation.
// The SVG uses a fixed viewBox of 28x28 and can be scaled via width/height props.

interface LobsterIconSvgProps {
  width: number;
  height: number;
}

export function LobsterIconSvg({ width, height }: LobsterIconSvgProps) {
  return (
    <svg
      width={width}
      height={height}
